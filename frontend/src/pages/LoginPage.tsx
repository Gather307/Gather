...
const LoginPage = ({ stateVariable, updateState }: { stateVariable: any, updateState: any }) => {
      ...
      <Box p={{ base: 4, md: 8 }} width="full" maxW={{ base: "90%", md: "md" }} borderWidth={1} borderRadius={8} boxShadow="lg" bg="white">
        <VStack spacing={6}>
          ...
          <FormControl id="username">
            ...
            <Input type="username"  borderColor="#216869" _hover={{ borderColor: '#49A078' }} onChange={(e) => {setUsername(e.target.value)}}/>
          </FormControl>
          <FormControl id="password">
            <FormLabel>Password</FormLabel>
            <Input type="password"  borderColor="#216869" _hover={{ borderColor: '#49A078' }} onChange={(e) => {setPassword(e.target.value)}}/>
          </FormControl>
          <Button colorScheme="teal" variant="solid" width="full" onClick={handleSubmit}>Login</Button>
